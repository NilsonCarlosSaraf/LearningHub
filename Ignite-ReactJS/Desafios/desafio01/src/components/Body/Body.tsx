    ...
    <body className="bg-gray600 h-screen flex flex-col items-center pt-16">
      <section className="flex w-1/3 justify-between">
        <div className="flex gap-2">
          <p className="text-blue-400 bold">Tarefas criadas</p>
          <div className="bg-gray500 rounded-full text-gray-100 px-3 justify-center flex">
            5
          </div>
        </div>
        <div className="flex gap-2">
          <p className="text-purple-500">Concluídas</p>
      ...
      <section className="h-2/3 w-1/3 ">
        {tasks.length !== 0 ? (
          ...
          <div className="flex flex-col items-center text-gray-400 pt-4 border-t-2 border-solid border-gray-500  w-1/3">
            <Note size={64} />
